...
![Valuation football field: DCF mid-cycle range and Monte Carlo P10–P90 against the price](freeport.figs/freeport_football.png)
...
![Monte Carlo distribution of normalized intrinsic value, with the margin-of-safety buy-band and the price](freeport.figs/freeport_montecarlo.png)
